...
function ProjectsTable() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8081/new_projects")
      .then((res) => {
          ...
          <table className="table proj">
            <thead>
              <tr>
                ...
                <th
                  className="text-center"
                  onClick={() => handleSort("catégorieProj")}
                >
                  <div>Catégorie</div>
                  <div>
                    <i className="fas fa-sort"></i>
                ...
                <th
                  className="text-center"
                  onClick={() => handleSort("intituléProj")}
                >
                  <div>Intitulé</div>
                  <div>
                    <i className="fas fa-sort"></i>
                ...
                <th
                  className="text-center"
                  onClick={() => handleSort("coordinateurProj")}
                >
                ...
                <tr key={project.id}>
                  ...
                  <td>
                    ...
                    <button
                      ...
                      className="btn mx-2 btn-danger delete"
                    >
                      Supprimer
                    </button>
                  </td>
